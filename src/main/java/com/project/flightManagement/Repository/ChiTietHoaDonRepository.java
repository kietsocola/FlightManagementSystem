...
public interface ChiTietHoaDonRepository extends JpaRepository<ChiTietHoaDon, Integer> {
    ...
    @Query("SELECT new com.project.flightManagement.DTO.HangHoaDTO.HanhKhach_HangHoaDTO(hh.idHangHoa, hh.tenHangHoa,hk.idHanhKhach, hk.hoTen,hk.cccd, hh.giaPhatSinh) " +
