    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((request) -> request
                        ...
                        //San bay
                        .requestMatchers(HttpMethod.GET, "/admin/sanbay/**").hasAuthority("Quản lí sân bay_VIEW")
                        .requestMatchers(HttpMethod.POST, "/admin/sanbay/**").hasAuthority("Quản lí sân bay_CREATE")
                        .requestMatchers(HttpMethod.PUT,"/admin/sanbay/**").hasAuthority("Quản lí sân bay_EDIT")
                        //Chuyen bay
