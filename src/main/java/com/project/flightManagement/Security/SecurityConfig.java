    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((request) -> request
                        ...
                        .requestMatchers("/admin/maybay/addPlane").hasAuthority("Quản lí máy bay_CREATE")
                        .requestMatchers("/admin/maybay/updatePlane/{idMB}").hasAuthority("Quản lí máy bay_EDIT")
                        .requestMatchers("/admin/maybay/blockPlane/{idMayBay}").hasAuthority("Quản lí máy bay_EDIT")
                        .requestMatchers("/admin/maybay/getHoursOfPlane/{idMayBay}").hasAuthority("Quản lí thống kê_VIEW")
                        // Danh Gia
